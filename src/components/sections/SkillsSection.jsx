...
const SkillsSection = ({ name, price, desc, img }) => {
    return (
        ...
        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div class="p-6">
            ...
            <h1 class="title-font text-lg font-medium  mb-3">{name}</h1>
            <p class="leading-relaxed mb-3">{desc}</p>
            <div class="flex items-center flex-wrap ">
              <a class=" inline-flex items-center md:mb-2 lg:mb-0">Learn More
